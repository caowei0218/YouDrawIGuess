package com.example.youdrawiguess.view;
...
public class ColorPickerView extends View {// 颜色选择器自定义View
	...
	private static final int CENTER_X = 300;// 圆环长
	private static final int CENTER_Y = 300;// 圆环宽
	private static final int CENTER_RADIUS = 100;

	public ColorPickerView(Context context,
						   OnColorChangedListener onColorChangedListener, int color) {
		super(context);
